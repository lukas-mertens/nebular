...
function installMainPeerDependencies(tree: Tree) {
  ...
  addDependencyToPackageJson(tree, '@devsaur-nebular/theme', nebularThemeVersion);
  addDependencyToPackageJson(tree, '@devsaur-nebular/eva-icons', nebularThemeVersion);
